...
function mostrartabla() {
    ...
    $('#contenido').load(dir_tbltabla, llenarDatatable);/* con esto le decimos que al hacer click nos
...
function mostrarFormRconsumo() {
    $('#contenido').load(dir_frmregistroConsumos, inicioJsFormRConsumos);
}
;
function mostrarFormRPA() {
    $('#contenido').load(dir_frmregistroPagoAgua, inicioJsFormPConsumos);
}
;
