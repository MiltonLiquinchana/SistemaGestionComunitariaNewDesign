...
function inicioJsFormRConsumos() {
    ...
    ref_input[10].addEventListener("click", limpiar);
    var fecha = new Date();
...
function calcular() {
    if (ref_input[4].value === "") {
        ...
        if (valor4 < valor3) {
            ...
            ref_select[1].innerHTML = `<option selected value="">Selecione un tipo de consumo</option>  `;
    ...
    if (ref_input[5].value !== "") {
        ...
        fetch("../Controles", {
            ...
            if (response.error) {
                ...
                ref_select[1].innerHTML = '';
                ref_select[1].innerHTML = `<option value="">Selecione un tipo de consumo</option>  `;
...
function guardarConsumo(e) {
    e.preventDefault();
    datos = new FormData();
    datos.append("lecturaAnterior", ref_input[3].value);
    datos.append("lecturaActual", ref_input[4].value);
    datos.append("conumoCubico", ref_input[5].value);
    datos.append("numMedidor", ref_select[0].value);
    datos.append("tipoConsumo", ref_select[1].value);
    datos.append("fechaRegistro", ref_input[6].value);
    datos.append("fechaLimite", ref_input[7].value);
    datos.append("totalPagar", ref_input[8].value);
...
function limpiar() {
    ...
    ref_input[8].value = "";
    ref_select[0].innerHTML = '';
    ref_select[0].innerHTML = `<option selected disabled value="">Seleccione un medidor</option>`;
    ref_select[1].innerHTML = '';
    ref_select[1].innerHTML = `<option selected value="">Selecione un tipo de consumo</option>`;
}